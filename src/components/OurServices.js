        ...
        <div className="container">
          ...
          <div className="row align-items-stretch">
            <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-plane"></span>
                </div>
                <div>
                  <h3>Air Freight</h3>
                  <p>
            ...
            >
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-boat-ship"></span>
                </div>
                <div>
                  <h3>Ocean Freight</h3>
                  <p>
            ...
            >
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-truck"></span>
                </div>
                <div>
            ...
            >
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-warehouse"></span>
                </div>
                <div>
                  <h3>Warehousing</h3>
                  <p>
            ...
            >
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-wooden"></span>
                </div>
                <div>
                  <h3>Storage</h3>
                  <p>
            ...
            >
              <div className="unit-4 d-flex">
                <div className="unit-4-icon mr-4">
                  <span className="text-primary flaticon-worldwide"></span>
                </div>
                <div>
